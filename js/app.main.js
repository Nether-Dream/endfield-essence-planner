  ...
  const app = createApp({
    ...
    setup() {
      ...
      return {
        ...
        syncStatusItems: state.syncStatusItems,
        syncStatusDisplayItems: state.syncStatusDisplayItems,
        syncStatusRenderItems: state.syncStatusRenderItems,
        syncHasStatusItems: state.syncHasStatusItems,
        syncStatusListRef: state.syncStatusListRef,
